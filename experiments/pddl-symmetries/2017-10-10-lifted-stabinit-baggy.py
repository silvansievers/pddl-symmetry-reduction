...
def main(revisions=None):
    ...
    configs = {
        IssueConfig('baggy-translate', [], driver_options=['--translate', '--translate-time-limit', '30m', '--translate-memory-limit', '2G']),
        IssueConfig('baggy-translate-stabinit', ['--translate-options', '--compute-symmetries', '--stabilize-initial-state', '--bliss-time-limit', '300', ], driver_options=['--translate', '--translate-time-limit', '30m', '--translate-memory-limit', '2G']),

        #IssueConfig('baggy-translate-stabinit-ground', ['--translate-options', '--compute-symmetries', '--stabilize-initial-state', '--ground-symmetries', '--bliss-time-limit', '300',], driver_options=['--translate', '--translate-time-limit', '30m', '--translate-memory-limit', '2G']),
        #IssueConfig('baggy-translate-stabinit-ground-noneofthose', ['--translate-options', '--compute-symmetries', '--stabilize-initial-state', '--ground-symmetries', '--add-none-of-those-mappings', '--bliss-time-limit', '300',], driver_options=['--translate', '--translate-time-limit', '30m', '--translate-memory-limit', '2G']),
    }
    ...
    exp.add_absolute_report_step(attributes=attributes,filter_algorithm=[
        '{}-baggy-translate'.format(REVISION),
        '{}-baggy-translate-stabinit'.format(REVISION),
        #'{}-baggy-translate-stabinit-ground'.format(REVISION),
        #'{}-baggy-translate-stabinit-ground-noneofthose'.format(REVISION),
