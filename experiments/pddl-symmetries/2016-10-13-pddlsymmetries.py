...
def main(revisions=None):
    ...
    configs = {
        IssueConfig('translate-allsymmetries', ['--translate-options', '--only-find-symmetries'], driver_options=['--translate']),
        IssueConfig('translate-objectsymmetries', ['--translate-options', '--only-find-symmetries', '--only-object-symmetries'], driver_options=['--translate']),
    }
