...
def main(revisions=None):
    ...
    configs = {
        ...
        IssueConfig('translate-stabinit-ground-noneofthose-mutexes', ['--translate-options', '--compute-symmetries', '--stabilize-initial-state', '--ground-symmetries', '--add-none-of-those-mappings', '--add-mutex-groups', '--bliss-time-limit', '300',], driver_options=['--translate', '--translate-time-limit', '30m']),
    }
