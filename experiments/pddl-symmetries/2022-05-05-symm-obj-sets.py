...
NEW_REV = 'b4509f30bd033a59f4889226af99847f9cb2fe06'
...
def main(revisions=None):
    ...
    OTHER_REV="c52296922d3ea405fafe661445ece7e4570d70f6"
    old_algorithm_nicks = [
        'translate-directsymmobjsets',
    ]
    path = Path.home()/'repos/downward/counter-abstractions/experiments/counter-abstractions/data/2021-01-18-translate-eval'
    exp.add_fetcher(
        path,
        filter_algorithm=['{}-{}'.format(OTHER_REV, x) for x in old_algorithm_nicks],
        merge=True,
        name="fetch-counter-abstraction")
    ...
    exp.add_step(
        'publish-comparison-report', subprocess.call, ['publish', outfile]
    )
