...
def main(revisions=None):
    ...
    configs = {
        ...
        IssueConfig('translate-onlyPNEinit', ['--translate-options', '--compute-symmetries', '--only-functions-from-initial-state', '--bliss-time-limit', '300', ], driver_options=['--translate', '--translate-time-limit', '30m']),
        IssueConfig('translate-onlyPNEinit-noneofthose', ['--translate-options', '--compute-symmetries', '--only-functions-from-initial-state', '--add-none-of-those-mappings', '--bliss-time-limit', '300',], driver_options=['--translate', '--translate-time-limit', '30m']),
        IssueConfig('translate-onlyPNEinit-mutexes', ['--translate-options', '--compute-symmetries', '--only-functions-from-initial-state', '--add-mutex-groups', '--bliss-time-limit', '300',], driver_options=['--translate', '--translate-time-limit', '30m']),
        IssueConfig('translate-onlyPNEinit-noneofthose-mutexes', ['--translate-options', '--compute-symmetries', '--only-functions-from-initial-state', '--add-none-of-those-mappings', '--add-mutex-groups', '--bliss-time-limit', '300',], driver_options=['--translate', '--translate-time-limit', '30m']),
    }
