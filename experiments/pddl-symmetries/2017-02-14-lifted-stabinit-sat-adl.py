...
def main(revisions=None):
    ...
    suite_all=['airport', 'airport-adl', 'assembly', 'barman-mco14-strips',
...
'woodworking-sat08-strips', 'woodworking-sat11-strips', 'zenotravel']
    suite_opt_strips=DEFAULT_OPTIMAL_SUITE
    suite = [x for x in suite_all if x not in suite_opt_strips]
    ...
    configs = {
        ...
        IssueConfig('translate-stabinit-noneofthose', ['--translate-options', '--compute-symmetries', '--stabilize-initial-state', '--add-none-of-those-mappings', '--bliss-time-limit', '300',], driver_options=['--translate', '--translate-time-limit', '30m']),
        IssueConfig('translate-stabinit-mutexes', ['--translate-options', '--compute-symmetries', '--stabilize-initial-state', '--add-mutex-groups', '--bliss-time-limit', '300',], driver_options=['--translate', '--translate-time-limit', '30m']),
        IssueConfig('translate-stabinit-noneofthose-mutexes', ['--translate-options', '--compute-symmetries', '--stabilize-initial-state', '--add-none-of-those-mappings', '--add-mutex-groups', '--bliss-time-limit', '300',], driver_options=['--translate', '--translate-time-limit', '30m']),
    }
