...
def main(revisions=None):
    ...
    exp.add_fetcher('data/2018-08-13-lifted-no-order-eval',filter_algorithm=['{}-{}'.format(OLD_REV, x) for x in old_algorithm_nicks])
    ...
    exp.add_fetcher('data/2018-08-09-lifted-eval',filter_algorithm=['{}-{}'.format(OLD_REV, x) for x in algorithm_nicks])
