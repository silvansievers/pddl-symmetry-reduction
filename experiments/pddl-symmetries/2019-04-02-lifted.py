...
def main(revisions=None):
    ...
    time_symmetries3_translate = Attribute('time_symmetries3_translate', absolute=False, min_wins=True, functions=[geometric_mean])
    ...
    OLD_REV = '8d6d1d2cda70'
    exp.add_fetcher('data/2019-03-26-lifted-eval',filter_algorithm=['{}-{}'.format(OLD_REV, x) for x in algorithm_nicks], merge=True)
