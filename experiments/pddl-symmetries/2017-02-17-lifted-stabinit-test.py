...
def main(revisions=None):
    ...
    simplify_var_removed = Attribute('simplify_var_removed', absolute=True, min_wins=True)
    simplify_val_removed = Attribute('simplify_val_removed', absolute=True, min_wins=True)
    reorder_var_removed = Attribute('reorder_var_removed', absolute=True, min_wins=True)
    ...
    extra_attributes = [
        ...
        simplify_var_removed,
        simplify_val_removed,
        reorder_var_removed,
    ]
