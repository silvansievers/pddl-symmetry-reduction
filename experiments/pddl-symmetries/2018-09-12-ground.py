...
def main(revisions=None):
    ...
    configs = {
        IssueConfig('ground-symmetries-stabgoal-stabinit', ['--symmetries', 'sym=structural_symmetries(time_bound=0,search_symmetries=dks,stabilize_goal=true,stabilize_initial_state=true,write_all_generators=true)', '--search', 'astar(blind(),symmetries=sym)']),
        IssueConfig('ground-symmetries-stabinit', ['--symmetries', 'sym=structural_symmetries(time_bound=0,search_symmetries=dks,stabilize_goal=false,stabilize_initial_state=true,write_all_generators=true)', '--search', 'astar(blind(),symmetries=sym)']),
        IssueConfig('ground-symmetries-stabgoal', ['--symmetries', 'sym=structural_symmetries(time_bound=0,search_symmetries=dks,stabilize_goal=true,stabilize_initial_state=false,write_all_generators=true)', '--search', 'astar(blind(),symmetries=sym)']),
        IssueConfig('ground-symmetries', ['--symmetries', 'sym=structural_symmetries(time_bound=0,search_symmetries=dks,stabilize_goal=false,stabilize_initial_state=false,write_all_generators=true)', '--search', 'astar(blind(),symmetries=sym)']),
    }
    ...
    exp.add_fetcher('data/2018-08-09-ground-eval',filter_algorithm=['{}-{}'.format(OLD_REV, x) for x in algorithm_nicks],filter=[rename_attributes])
